...
@Component({
  selector: 'app-full-text-search-form',
  templateUrl: './full-text-search-form.component.html',
  styleUrls: ['./full-text-search-form.component.scss'],
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class FullTextSearchFormComponent implements OnInit {
  ...
  ngOnInit(): void {
    this.searchForm = this.fb.group({
      ...
      searchIn: ['question', Validators.required],
      dateFrom: null,
      dateTo: null,
    });
  }
